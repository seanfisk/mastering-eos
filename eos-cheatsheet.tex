  ...
  \begin{columns}
    \begin{column}{0.33\textwidth}
      ...
      \begin{block}{Inter-EOS Password-less SSH}
        {\tiny \inputminted[tabsize=2]{bash}{scripts/ssh.bash}}
        {\footnotesize For more security, use a passphrase and \texttt{ssh-agent}.}
      \end{block}
      ...
      \begin{block}{Multiple terminals}
        ...
        {\newcommand{\key}[1]{\texttt{C-b #1}}
          \command{C-b c} means \command{Control + b}, then \command{c}.

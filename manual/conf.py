...
# pixels large.
#
# Since we are GVSU-approved, we are using the file from
# <http://gvsu.edu/favicon.ico>.
#
# Although this file is not in the static path, it will be copied to it
# automatically by Sphinx. We didn't put it in the static path to allow Sphinx
# to put it wherever it wants.
...
#
# This needs to be specified, or else files in the '_static' dir won't be
# copied.

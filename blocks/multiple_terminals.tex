\begin{block}{Multiple terminals}
  An alternative to opening multiple terminals running \texttt{ssh} or multiple PuTTY windows is to use a terminal multiplexer such as \texttt{screen} or \texttt{tmux}. \texttt{tmux} is recommended. Type \command{tmux} once SSH'd to start it. \\[0.7em]
